...
export declare type RangeOfInclusive<To extends number> = Partial<TupleOf<unknown, To>>["length"];
 ...
 */
export declare type RangeOf<To extends number> = Partial<Head<TupleOf<unknown, To>>>["length"];
/**
 ...
 */
export declare type Remainders<Length extends number, Index extends number> = Partial<UnionToTuple<Exclude<RangeOfInclusive<Length>, RangeOfInclusive<Index>>>>["length"] & number;
export {};
